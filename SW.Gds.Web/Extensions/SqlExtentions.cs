...
namespace SW.Gds
{
    ...
    {
        async public static Task ExecuteSql(this DbConnection sqlConnection, string sql)
        {
        ...
        async public static Task<HashSet<string>> QueryField(this DbConnection sqlConnection, string sql, string field)
        {
        ...
        async public static Task<IEnumerable<IDictionary<string, string>>> QueryFields(this DbConnection sqlConnection, string sql, IList<string> fields)
        {
